<template>
	<BasePager ghost :back="route('page.manager.todo.approval')">
...
import { useApprovalNodes, useApprovalOptions } from "./hooks/approval"
...
const tableColumns = () => [
	...
	},*/
	{
		...
		customRender: ({ record }) => useApprovalNodes({ record, tasks: record.approval_tasks }),
	},
	{
		title: "审核类型",
		dataIndex: "type",
